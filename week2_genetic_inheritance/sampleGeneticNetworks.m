...
sampleFactorListMine = constructGeneticNetwork(pedigree, alleleFreqs, alphaList);
...
phenotypeFactorPar2 = phenotypeGivenCopiesFactor(alphaListThree, numAllelesThree, genotypeVarMotherCopy, genotypeVarFatherCopy, phenotypeVar);
...
sampleFactorListDecoupledMine = constructDecoupledGeneticNetwork(pedigree, alleleFreqsThree, alphaListThree);
...
phenotypeFactorSigmoidMine = constructSigmoidPhenotypeFactor(alleleWeights, geneCopyVarParentOneList, geneCopyVarParentTwoList, phenotypeVar);
