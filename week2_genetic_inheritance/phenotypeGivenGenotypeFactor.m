...
phenotypeFactor = struct('var', [phenotypeVar, genotypeVar], ...
                         'card', [2, length(alphaList)], 'val', []);
...
phenotypeFactor.val = reshape([alphaList'; 1-alphaList'], ...
            [1, prod(phenotypeFactor.card)]);
